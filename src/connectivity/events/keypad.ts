 ...
 */
export type KeyDown<TSettings extends PayloadObject<TSettings>> = ActionEvent<"keyDown", KeypadPayload<TSettings>>;

/**
 * Occurs when the user releases a pressed action. **NB** For dials / touchscreens see {@link DialUp}. Also see {@link KeyDown}.
 */
export type KeyUp<TSettings extends PayloadObject<TSettings>> = ActionEvent<"keyUp", KeypadPayload<TSettings>>;
