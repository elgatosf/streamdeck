...
export type DidReceiveSettingsEvent<TSettings extends JsonObject = JsonObject> = ActionEvent<
	...
	DialAction<TSettings> | KeyAction<TSettings> | KeyInMultiAction<TSettings>
>;

/**
 * Event information received from Stream Deck when a key is pressed down.
 */
export type KeyDownEvent<TSettings extends JsonObject = JsonObject> = ActionEvent<KeyDown<TSettings>, KeyAction<TSettings> | KeyInMultiAction<TSettings>>;

/**
 * Event information received from Stream Deck when a pressed key is release.
 */
export type KeyUpEvent<TSettings extends JsonObject = JsonObject> = ActionEvent<KeyUp<TSettings>, KeyAction<TSettings> | KeyInMultiAction<TSettings>>;
