 ...
 */
export type DialDownEvent<TSettings extends JsonObject> = ActionEvent<DialDown<TSettings>, Action<TSettings>>;

/**
 * Event information received from Stream Deck when a dial is rotated.
 */
export type DialRotateEvent<TSettings extends JsonObject> = ActionEvent<DialRotate<TSettings>, Action<TSettings>>;

/**
 * Event information received from Stream Deck when a pressed dial is released.
 */
export type DialUpEvent<TSettings extends JsonObject> = ActionEvent<DialUp<TSettings>, Action<TSettings>>;
 ...
 */
export type KeyDownEvent<TSettings extends JsonObject> = ActionEvent<KeyDown<TSettings>, Action<TSettings>>;

/**
 * Event information received from Stream Deck when a pressed key is release.
 */
export type KeyUpEvent<TSettings extends JsonObject> = ActionEvent<KeyUp<TSettings>, Action<TSettings>>;

/**
 * Event information received from Stream Deck when the property inspector appears.
 */
export type PropertyInspectorDidAppearEvent<TSettings extends JsonObject> = ActionWithoutPayloadEvent<PropertyInspectorDidAppear, Action<TSettings>>;

/**
 * Event information received from Stream Deck when the property inspector disappears.
 */
export type PropertyInspectorDidDisappearEvent<TSettings extends JsonObject> = ActionWithoutPayloadEvent<PropertyInspectorDidDisappear, Action<TSettings>>;

/**
 * Event information received from Stream Deck when the title, or title parameters, change.
 */
export type TitleParametersDidChangeEvent<TSettings extends JsonObject> = ActionEvent<TitleParametersDidChange<TSettings>, Action<TSettings>>;
 ...
 */
export type TouchTapEvent<TSettings extends JsonObject> = ActionEvent<TouchTap<TSettings>, Action<TSettings>>;

/**
 * Event information received from Stream Deck when an action appears on the canvas.
 */
export type WillAppearEvent<TSettings extends JsonObject> = ActionEvent<WillAppear<TSettings>, Action<TSettings>>;

/**
 * Event information received from Stream Deck when an action disappears from the canvas.
 */
export type WillDisappearEvent<TSettings extends JsonObject> = ActionEvent<WillDisappear<TSettings>, Action<TSettings>>;
