import type { ActionIdentifier, Controller, Coordinates, DeviceIdentifier } from "../events";
 ...
 */
type ActionInfoPayload<T extends Controller> = {
	/**
	 ...
	 */
	readonly coordinates: Coordinates<T extends "Encoder" ? 0 : number>;
};
